...
REGRESS = libsqlite extra/sqlite_fdw_post $(DATA_TYPE_TESTS) extra/join extra/limit extra/aggregates extra/prepare extra/select_having extra/select extra/insert extra/update extra/schemas_pragmas extra/encodings sqlite_fdw aggregate selectfunc $(GIS_DEP_TESTS)
endif
