...
--Testcase 251:
\connect contrib_regression no_admin;
--Testcase 252: ERR - no rigths
SELECT sqlite_fdw_db_attach('sqlite_svr', '/tmp/sqlite_fdw_test/common.db', '試験 +', 'none');
--Testcase 253: ERR - no rigths
SELECT sqlite_fdw_db_detach('sqlite_svr', '試験 +');
--Testcase 254:
\connect -reuse-previous=off contrib_regression;
--Testcase 255:
DROP USER no_admin;

-- Not superuser, but FOREIGN SERVER's owner test
--Testcase 256:
CREATE USER sqlite_svr_owner;
--Testcase 257:
CREATE USER sqlite_svr_owner_role;
--Testcase 258:
GRANT sqlite_svr_owner TO sqlite_svr_owner_role;
--Testcase 259:
ALTER SERVER sqlite_svr OWNER TO sqlite_svr_owner;
--Testcase 260:
\connect -reuse-previous=off contrib_regression sqlite_svr_owner_role;
--Testcase 261: ERR because GRANT
SELECT sqlite_fdw_db_attach('sqlite_svr', '/tmp/sqlite_fdw_test/common.db', '試験 +', 'none');
--Testcase 262: ERR because GRANT
SELECT sqlite_fdw_db_detach('sqlite_svr', '試験 +');
--Testcase 263:
\connect -reuse-previous=off contrib_regression sqlite_svr_owner;
--Testcase 264:
SELECT sqlite_fdw_db_attach('sqlite_svr', '/tmp/sqlite_fdw_test/common.db', '試験 +', 'none');
--Testcase 265:
SELECT sqlite_fdw_db_detach('sqlite_svr', '試験 +');
...
\connect -reuse-previous=off contrib_regression;
--Testcase 265:
DROP USER sqlite_svr_owner_role;
